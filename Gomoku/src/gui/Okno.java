...
//		 menu
		...
		igraClovekRacunalnik = new JMenuItem("»lovek - RaËunalnik");
		igra_menu.add(igraClovekRacunalnik);
		igraClovekRacunalnik.addActionListener(this);
		
		igraRacunalnikClovek = new JMenuItem("RaËunalnik - »lovek");
		...
		igraRacunalnikRacunalnik = new JMenuItem("RaËunalnik - RaËunalnik");
	...
	public void osveziGUI() {
		if (Vodja.igra == null) {
			...
			case V_TEKU: 
				...
				break;
			case ZMAGA_B: 
				status.setText("Zmagal je Ërni igralec!");
				break;
			case ZMAGA_W: 
